...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
            ...
            "addRack", "亲，该货架名已存在，请重新填写"   
            
            var noinput="${addRack}";
            if(noinput=="亲，该货架名已存在，请重新填写"){
            	alert(noinput);
            }
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/img/allbg.gif'>
			<form action="addRackAction.action" method="post" name="formAdd">
				     <table width="98%" border="0" cellpadding="5" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
						...
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						  <td width="25%" bgcolor="#FFFFFF" align="right">
						    ...
						    <select name="rb.ofCangId"  style="width:150px">
						...
						货架名称：
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="rb.rackId" id="RackId" size="30"/>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						    <td width="25%" bgcolor="#FFFFFF" align="right">
