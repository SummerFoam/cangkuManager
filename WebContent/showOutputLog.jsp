...
<body>
		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1"
			...
			<tr bgcolor="#E7E7E7">
				<td height="14" colspan="100" background="">&nbsp;>>商品出货记录&nbsp;</td>
			</tr>
			...
			<s:iterator value="list">
				...
				<tr align='center' bgcolor="#FFFFFF"
                   ...
                   <td bgcolor="#FFFFFF" align="center">
					...
					<td bgcolor="#FFFFFF" align="center"><s:property value="chuHuo"/> </td>
					<td bgcolor="#FFFFFF" align="center"><s:property value="shouHuo"/> </td>
					<td bgcolor="#FFFFFF" align="center"><s:property value="date2"/> </td>

				   <td bgcolor="#FFFFFF" align="center"><a href="deleteOutputLog.action?id=${id}" onclick="return tishi()">删除</a>
					</td>
				</tr>
			</s:iterator>
		</table>
