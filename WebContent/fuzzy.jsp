...
<body>
	<form action="/cangKuManage/findAll.action" method="post">
		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1"
			...
			<tr bgcolor="#E7E7E7">
				<td height="14" colspan="100" background="">&nbsp;>>关于"
				<font color="red" size="4">${fuzzyName}</font>"的商品管理&nbsp;</td>
			</tr>
			...
			<s:iterator value="list">
				<tr align='center' bgcolor="#FFFFFF"
				 ...
				 <s:property value="goodsId"/>
					...
					<td bgcolor="#FFFFFF" align="center">
					<a href="updataFindProduct.action?goodsId=${goodsId }" target="right">修改</a>
					</td>
...
<a href="fuzzyProductName.action?pageIndex=1" target="content">首页</a>
<a href="fuzzyProductName.action?pageIndex=${pageIndex-1 }" target="content">上一页</a>	
<a href="fuzzyProductName.action?pageIndex=${pageIndex+1 }" target="content">下一页</a>	
<a href="fuzzyProductName.action?pageIndex=${pageCount}" target="content">尾页</a>				          
