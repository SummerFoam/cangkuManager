...
function tishi(){
	...
	return false;
           ...
           function catelogAdd()
           {
                 var url="<%=path%>/addSelAllType.action";
				 window.location.href=url;
           }
           
           var noinput="${cate}";
           if(noinput=="亲，还存该类别的商品，不能删除"){
           	alert(noinput);
           }
...
<body>
	<form action="/cangKuManage/findAll.action" method="post">
		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1"
			...
			<tr bgcolor="#E7E7E7">
				<td height="14" colspan="100" background="">&nbsp;>>商品类别管理&nbsp;</td>
			</tr>
			...
			<s:iterator value="#GTList" var="list">
				<tr align='center' bgcolor="#FFFFFF"
					onMouseMove="javascript:this.bgColor='red';"
					onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					<td bgcolor="#FFFFFF" align="center"><s:property value="#list.categoryId"/></td>
					<td bgcolor="#FFFFFF" align="center"><s:property value="#list.categoryName" /></td>
					<td bgcolor="#FFFFFF" align="center"><s:property value="#list.ofRackid" /></td>
					<td bgcolor="#FFFFFF" align="center">
					<a href="deleteType.action?deleteCategoryId=${categoryId}" onclick="return tishi()">删除</a>
					</td>
					<td bgcolor="#FFFFFF" align="center">
					<a href="SelTypeID.action?gcd.CategoryId=${categoryId}">修改</a>
					</td>
				</tr>
			</s:iterator>
